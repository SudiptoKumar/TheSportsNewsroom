...
def prepare_evergreen_media(story: dict) -> tuple[str, dict]:
    """Select a relevant photo using normal search first, verify/download it, then fall back to Exa and finally a card."""
