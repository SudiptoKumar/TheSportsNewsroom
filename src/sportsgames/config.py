...
MAX_EDITORIAL_SHORTLIST = int(os.getenv("MAX_EDITORIAL_SHORTLIST", "24"))
...
# Number of high-quality candidates searched in each content family.
SEARCHES_PER_RUN = int(os.getenv("SEARCHES_PER_RUN", "16"))

# Telegram Rich Message is the preferred renderer. sendPhoto remains the fallback.
MAX_RICH_CHARACTERS = 32768
MAX_CAPTION_CHARACTERS = 1000

HEADERS = {
    "User-Agent": "TheSportsNewsroomDiscoveryEngine/2.0 (+https://t.me/TheSportsNewsroom)",
